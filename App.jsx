...
import ProductScreen from './src/callocean-screens/ProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://prime-grid-port.site/`;
  const URL_IDENTIFAIRE = `m2o8SEts`;
  ...
  OneSignal.initialize('32912454-5d6e-491e-9622-be3caca07569');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-04T08:08:00'); //дата з якої поч працювати webView
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./src/callocean-assets/img/111.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./src/callocean-assets/img/222.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
